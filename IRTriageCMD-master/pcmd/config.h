...
/*Define to enable dynamic TRACE info in console */
#define CMD_TRACE_DYNAMIC

/*Define to enable integrated perl interpreter */
//#define CMD_PERL_INTEGRATE

/*Define to enable custom plugin functions */
#define CMD_CUSTOM_PLUGINS

/*Define if having pageprompts */
/*#define CMD_PAGEPROMPT */
