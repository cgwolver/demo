...
void PictureBox::mousePressEvent(QMouseEvent*e)
{
...
void PictureBox::mouseMoveEvent(QMouseEvent*e)
{
    return QWidget::mouseMoveEvent(e);
}

void PictureBox::mouseReleaseEvent(QMouseEvent*e)
{
...
bool PictureBox::event(QEvent *e)
{
